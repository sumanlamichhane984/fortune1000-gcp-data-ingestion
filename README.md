...
The original dataset was loaded through the pipeline and stored in BigQuery. For safety and compliance, only a small synthetic sample is included in this repository.
